# Guia de Emergências - Serras Gaúchas 2026
...
| **Bombeiros** | 193 | Resgate, incêndio |
| **Polícia Militar** | 190 | Segurança |
| **Polícia Rodoviária Federal** | 191 | Rodovias federais |
...
## Hospitais e Pronto-Socorros por Região

### Ponta Grossa - PR

| Hospital | Tipo | Telefone | Endereço |
|----------|------|----------|----------|
| **Hospital Universitário** | Público | (42) 3220-3000 | Campus Uvaranas |
| **Santa Casa** | Filantrópico | (42) 3026-8000 | R. Comendador Miró, 851 |
| **UPA Centro** | Urgência | (42) 3222-2200 | R. Dr. Paula Xavier |

### Lages - SC

| Hospital | Tipo | Telefone | Endereço |
|----------|------|----------|----------|
| **Hospital Geral** | Público | (49) 3223-3000 | Av. Dom Daniel Hostin |
| **Hospital Nossa Senhora dos Prazeres** | Privado | (49) 3222-3222 | R. Frei Rogério |
| **UPA 24h** | Urgência | (49) 3251-6300 | Bairro Coral |

### Urubici - SC

| Hospital | Tipo | Telefone | Endereço |
|----------|------|----------|----------|
| **Hospital São José** | Único | (49) 3278-1200 | R. Adolfo Konder, 230 |

> **ATENÇÃO:** Hospital pequeno. Casos graves: remoção para Lages (110 km)

### São Joaquim - SC

| Hospital | Tipo | Telefone | Endereço |
|----------|------|----------|----------|
| **Hospital Regional** | Público | (49) 3233-0600 | R. Marcos Batista, 55 |
| **Posto de Saúde Central** | Básico | (49) 3233-1100 | Centro |

> **ATENÇÃO:** Hospital limitado. Casos graves: Lages ou Florianópolis

### Cambará do Sul - RS

| Hospital | Tipo | Telefone | Endereço |
|----------|------|----------|----------|
| **Posto de Saúde** | Básico | (54) 3251-1200 | Centro |

> **ATENÇÃO:** Cidade pequena, sem hospital. Emergências: São José dos Ausentes ou Vacaria

### Gramado - RS

| Hospital | Tipo | Telefone | Endereço |
|----------|------|----------|----------|
| **Hospital Arcanjo São Miguel** | Privado | (54) 3286-2100 | R. São Pedro, 968 |
| **UPA Gramado** | Urgência | (54) 3286-7100 | Av. das Hortênsias |
| **Hospital de Canela** | Próximo | (54) 3282-2333 | 8 km |

### Bento Gonçalves - RS

| Hospital | Tipo | Telefone | Endereço |
|----------|------|----------|----------|
| **Hospital Tacchini** | Privado | (54) 2102-8000 | R. 13 de Maio, 479 |
| **Posto Central** | Público | (54) 3055-7000 | Centro |
...
| Cidade | Oficina | Telefone | Especialidade |
|--------|---------|----------|---------------|
| **Ponta Grossa** | MotoCenter PG | (42) 99999-0001 | Big trails |
| **Lages** | Moto Lages | (49) 99999-0002 | Geral |
...
### Locais com Serviço para Moto

| Cidade | Nome | Telefone | Observação |
|--------|------|----------|------------|
...
## Postos de Combustível 24h

### Na Rota

| Cidade | Posto | Localização |
|--------|-------|-------------|
| **Ponta Grossa** | Shell BR-376 | Saída para Curitiba |
| **Lages** | Ipiranga BR-116 | Entrada da cidade |
| **Urubici** | Petrobras Centro | Único 24h (verificar) |
...
| Tipo | Cobertura Mínima | Observação |
|------|------------------|------------|
| **Médico-hospitalar** | R$ 50.000 | Acidentes de moto |
| **Translado médico** | R$ 30.000 | Remoção UTI |
| **Repatriação** | Incluído | Retorno emergencial |
| **Bagagem** | R$ 3.000 | Equipamentos |

### Seguradoras com Cobertura Moto

| Seguradora | Telefone | Site |
|------------|----------|------|
| **Porto Seguro** | 0800 727 0800 | portoseguro.com.br |
| **Bradesco Seguros** | 0800 701 7000 | bradescoseguros.com.br |
| **Allianz** | 0800 115 215 | allianz.com.br |

---

## Aplicativos Úteis para Emergências

| App | Função | Baixar Offline? |
|-----|--------|-----------------|
| **SOS Emergências** | Localiza hospitais | Sim |
| **Detran Digital** | Consulta CNH/CRLV | Sim |
| **Waze** | Trânsito em tempo real | Mapas offline |
| **Google Maps** | Navegação | Mapas offline |
| **WhatsApp** | Contato emergência | - |
...
- [ ] Saia da pista se possível
- [ ] Ligue o pisca-alerta
- [ ] Coloque triângulo a 50m
- [ ] Vista colete refletivo

### 2. Avaliação
- [ ] Verifique ferimentos próprios
- [ ] Não remova o capacete de vítimas
- [ ] Não mova vítimas com suspeita de lesão na coluna
...
### 4. Documentação
- [ ] Fotografe a cena
- [ ] Anote placa de outros veículos
- [ ] Pegue dados de testemunhas
- [ ] Registre B.O. se necessário

---

## Contatos Pessoais de Emergência

**Preencha antes de viajar:**

| Contato | Nome | Telefone |
|---------|------|----------|
| Familiar 1 | _____________ | _____________ |
| Familiar 2 | _____________ | _____________ |
| Médico pessoal | _____________ | _____________ |
| Seguro moto | _____________ | Apólice: _______ |
| Seguro viagem | _____________ | Apólice: _______ |

---

## Farmácias 24h na Rota

| Cidade | Farmácia | Telefone |
|--------|----------|----------|
| **Ponta Grossa** | Drogasil Centro | (42) 3224-0000 |
...
1. **Compartilhe localização** em tempo real (Google Maps)
2. **Agende check-ins** diários com família
3. **Não pilote cansado** - pare a cada 2 horas
4. **Hidrate-se** - altitude resseca
5. **Cuidado com animais** na pista (especialmente à noite)
6. **Neblina nas serras** - reduza velocidade, use farol baixo
7. **Piso molhado** - freie antecipadamente
8. **Nunca ultrapasse em curvas** nas serras
